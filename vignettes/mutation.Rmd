...
```{r results = 'hide', echo=TRUE, eval =F, message=FALSE, warning=FALSE}
query.maf.hg19 <- GDCquery(project = "TCGA-CHOL", 
                           ...
                           legacy = TRUE)
```
```{r  echo = TRUE, message = FALSE, eval = F,warning = FALSE}
...
```{r  results = "hide",echo = TRUE, message = FALSE,eval = F, warning = FALSE}
library(maftools)
